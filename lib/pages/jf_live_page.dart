...
import 'package:flutterapp1/pages/live_page.dart';
import 'package:flutterapp1/widget/round_indicator.dart';
import 'package:fluttertoast/fluttertoast.dart';

///直播列表首页
class JfLivePage extends StatefulWidget {

  bool show = true;

  @override
  createState() => _JfLivePageState();
}

class _JfLivePageState extends State<JfLivePage> {
  int index = 1;
